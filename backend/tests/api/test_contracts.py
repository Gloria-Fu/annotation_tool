...
EXPECTED_OPERATIONS = {
    ...
    ("GET", "/api/v1/quality-batches/{batch_id}"),
    ("POST", "/api/v1/quality-batches/{batch_id}/items/{item_id}/check"),
    ...
    ("PUT", "/api/v1/work-items/{item_id}/review-draft"),
    ("POST", "/api/v1/work-items/{item_id}/clear"),
    ("POST", "/api/v1/work-items/{item_id}/quality-check"),
    ("GET", "/api/v1/work-items/{item_id}/quality-history"),
    ("GET", "/api/v1/work-items/{item_id}/data"),
    ("GET", "/api/v1/work-items/{item_id}/media/{media_key}"),
    ("GET", "/api/v1/stats"),
    ("GET", "/api/v1/reports/tasks.csv"),
    ("GET", "/api/v1/work-statistics/me"),
    ("GET", "/api/v1/work-statistics/people"),
    ("GET", "/api/v1/work-statistics/me.csv"),
    ("GET", "/api/v1/work-statistics/people.csv"),
}
...
PROTECTED_REQUESTS = [
    ...
    ("POST", "/api/v1/quality-batches", {"package_id": "package-id"}),
    ("GET", "/api/v1/quality-batches", None),
    ("GET", "/api/v1/quality-batches/batch-id", None),
    (
        "POST",
        "/api/v1/quality-batches/batch-id/items/item-id/check",
        {"result": "passed", "batch_id": "batch-id"},
    ),
    ...
    ("PUT", "/api/v1/work-items/item-id/review-draft", {"payload": {"segments": []}}),
    ("POST", "/api/v1/work-items/item-id/clear", None),
    ("POST", "/api/v1/work-items/item-id/quality-check", {"result": "passed"}),
    ("GET", "/api/v1/work-items/item-id/quality-history", None),
    ...
    ("GET", "/api/v1/work-statistics/me?project_id=project-id", None),
    ("GET", "/api/v1/work-statistics/people?project_id=project-id", None),
    ("GET", "/api/v1/work-statistics/me.csv?project_id=project-id", None),
    ("GET", "/api/v1/work-statistics/people.csv?project_id=project-id", None),
]
